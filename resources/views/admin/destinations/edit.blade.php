...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Destination</h1>
        ...
        <form action="{{ route('admin.destinations.update', $destination) }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="short_description" id="short_description" rows="3" required
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('short_description', $destination->short_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="region" id="region" required
                            ...
                            @foreach($regions as $key => $region)
                                <option value="{{ $key }}" {{ old('region', $destination->region) == $key ? 'selected' : '' }}>{{ $region }}</option>
                            @endforeach
                        </select>
                        @error('region')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="capital" id="capital" value="{{ old('capital', $destination->capital) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label for="currency" class="block text-sm font-medium text-gray-700 mb-2">Currency</label>
                            <input type="text" name="currency" id="currency" value="{{ old('currency', $destination->currency) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="language" id="language" value="{{ old('language', $destination->language) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="average_tuition_fee" id="average_tuition_fee" value="{{ old('average_tuition_fee', $destination->average_tuition_fee) }}" step="0.01"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label for="average_living_cost" class="block text-sm font-medium text-gray-700 mb-2">Average Living Cost</label>
                            <input type="number" name="average_living_cost" id="average_living_cost" value="{{ old('average_living_cost', $destination->average_living_cost) }}" step="0.01"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="universities_count" id="universities_count" value="{{ old('universities_count', $destination->universities_count) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label for="programs_count" class="block text-sm font-medium text-gray-700 mb-2">Programs Count</label>
                            <input type="number" name="programs_count" id="programs_count" value="{{ old('programs_count', $destination->programs_count) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="order" id="order" value="{{ old('order', $destination->order) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            @if($destination->featured_image)
                                <div class="mb-2">
                                    <img src="{{ $destination->featured_image_url }}" alt="Current featured image" class="w-32 h-24 object-cover rounded">
                                </div>
                            @endif
                        ...
                        <div>
                            ...
                            @if($destination->flag_image)
                                <div class="mb-2">
                                    <img src="{{ $destination->flag_image_url }}" alt="Current flag image" class="w-24 h-16 object-cover rounded">
                                </div>
                            @endif
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $destination->is_active) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            <label for="is_active" class="ml-2 block text-sm text-gray-900">Active</label>
                        </div>

                        <div class="flex items-center">
                            <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $destination->is_featured) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
            ...
            <div class="mt-6">
                ...
                <textarea name="content" id="content" rows="15" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('content', $destination->content) }}</textarea>
                @error('content')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
                    ...
                    <div id="requirements-container" class="space-y-2">
                        @if($destination->requirements && count($destination->requirements) > 0)
                            @foreach($destination->requirements as $requirement)
                                <div class="flex">
                                    <input type="text" name="requirements[]" value="{{ $requirement }}" placeholder="Enter requirement"
                                           class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <button type="button" onclick="removeField(this)" class="ml-2 text-red-600 hover:text-red-800">
                                        <i class="fas fa-times"></i>
                                    </button>
                    ...
                    <div id="benefits-container" class="space-y-2">
                        @if($destination->benefits && count($destination->benefits) > 0)
                            @foreach($destination->benefits as $benefit)
                                <div class="flex">
                                    <input type="text" name="benefits[]" value="{{ $benefit }}" placeholder="Enter benefit"
                                           class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <button type="button" onclick="removeField(this)" class="ml-2 text-red-600 hover:text-red-800">
                                        <i class="fas fa-times"></i>
                                    </button>
            ...
            <div class="mt-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $destination->meta_title) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('meta_description', $destination->meta_description) }}</textarea>
                </div>
            </div>
