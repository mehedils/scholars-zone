...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Create Student Essential</h1>
            <p class="text-sm sm:text-base text-gray-600">Add a new student essential service to your our-services page.</p>
        </div>
