            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <input type="text" 
                           name="title" 
                           id="title" 
                           value="{{ old('title', $studentEssential->title) }}"
                ...
                <div class="lg:col-span-2">
                    ...
                    <textarea name="description" 
                              ...
                              required>{{ old('description', $studentEssential->description) }}</textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           name="icon" 
                           id="icon" 
                           value="{{ old('icon', $studentEssential->icon) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="order" 
                           id="order" 
                           value="{{ old('order', $studentEssential->order) }}"
                           min="0"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="0">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="show_learn_more"
                               value="1"
                               {{ old('show_learn_more', $studentEssential->show_learn_more) ? 'checked' : '' }}
                ...
                <!-- Learn More URL -->
                <div id="learn_more_url_container">
                ...
                <div class="lg:col-span-2">
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="is_active"
                               value="1"
                               {{ old('is_active', $studentEssential->is_active) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
...
document.getElementById('show_learn_more').addEventListener('change', function() {
    const urlContainer = document.getElementById('learn_more_url_container');
